const UI = {
  ...
  init() {
    ...
    document.getElementById('btn-retry').addEventListener('click', (e) => { e.stopPropagation(); this.hideAll(); Game.start(); Game.state = 'ready'; this.show('ready-screen'); });
...
document.addEventListener('DOMContentLoaded', () => {
  if (window.ArcadeAnalytics) {
    ...
    ArcadeAnalytics.track('game_start', { game: 'sky-drift' });
  }
  Audio.init();
